"use strict";
(self["webpackChunkmoebytes_site"] = self["webpackChunkmoebytes_site"] || []).push([["806"], {
6701(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
const debug = browser('music-metadata:parser:MP4:atom');
...
const Header = {
    ...
    put: (buf, off, hdr) => {
        ...
        return FourCC/* .FourCcToken.put */.e.put(buf, off + 4, hdr.name);
    }
};
/**
 ...
 */
const mhdr = (/* unused pure expression or super */ null && ({
    len: 8,
    get: (buf, off) => {
        return {
...
class SampleDescriptionTable {
    ...
    get(buf, off) {
        ...
        return {
            dataFormat: FourCC/* .FourCcToken.get */.e.get(buf, off),
...
const Atom_debug = browser('music-metadata:parser:MP4:Atom');
class Atom {
...
var matroska_types = __webpack_require__(7588);
...
const MP4Parser_debug = browser('music-metadata:parser:MP4');
            ...
            track.soundSampleDescription.forEach(ssd => {
                ...
                if (ssd.description) {
                    ...
                    if (description.sampleRate > 0) {
                        streamInfo.type = matroska_types/* .TrackType.audio */.S.audio;
                        streamInfo.audio = {
