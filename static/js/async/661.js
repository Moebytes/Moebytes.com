"use strict";
(self["webpackChunkmoebytes_site"] = self["webpackChunkmoebytes_site"] || []).push([["661"], {
4036(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
class Common {
    ...
    get(buf, off) {
        ...
        if (this.isAifc) {
            res.compressionType = FourCC/* .FourCcToken.get */.e.get(buf, off + 18);
            if (this.len > 22) {
