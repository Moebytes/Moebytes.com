"use strict";
(self["webpackChunkmoebytes_site"] = self["webpackChunkmoebytes_site"] || []).push([["153"], {
1848(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
const debug = browser('music-metadata:parser:ebml');
...
const MatroskaParser_debug = browser('music-metadata:parser:matroska');
/**
                        ...
                        { // tracks
                            ...
                            if (audioTracks?.entries) {
                                ...
                                const audioTrack = audioTracks.entries
                                    .filter(entry => entry.trackType === types/* .TrackType.audio */.S.audio)
                                    .reduce((acc, cur) => {
                                    if (!acc)
                                        return cur;
