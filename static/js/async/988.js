"use strict";
(self["webpackChunkmoebytes_site"] = self["webpackChunkmoebytes_site"] || []).push([["988"], {
...
5855(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
 ...
 */
const NameCode = (/* unused pure expression or super */ null && ({
    /**
     * not set
     */
    not_set: 0,
 ...
 */
const ReplayGainOriginator = (/* unused pure expression or super */ null && ({
    /**
...
const debug = browser('music-metadata:parser:mpeg');
    ...
    async sync() {
        ...
        while (true) {
            ...
            if (this.syncPeek.len <= 163) {
                throw new core/* .EndOfStreamError */.d1();
            }
            while (true) {
