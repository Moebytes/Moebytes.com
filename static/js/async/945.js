"use strict";
(self["webpackChunkmoebytes_site"] = self["webpackChunkmoebytes_site"] || []).push([["945"], {
...
1280(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
const debug = browser('music-metadata:parser:musepack:sv8');
...
const MpcSv8Parser_debug = browser('music-metadata:parser:musepack');
...
const MpcSv7Parser_debug = browser('music-metadata:parser:musepack');
...
const MusepackParser_debug = browser('music-metadata:parser:musepack');
