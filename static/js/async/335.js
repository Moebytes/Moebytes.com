"use strict";
(self["webpackChunkmoebytes_site"] = self["webpackChunkmoebytes_site"] || []).push([["335"], {
6010(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
const BlockHeaderToken = {
    ...
    get: (buf, off) => {
        ...
        const res = {
            // should equal 'wvpk'
            BlockID: FourCC/* .FourCcToken.get */.e.get(buf, off),
...
const debug = browser('music-metadata:parser:WavPack');
